...
import { ApplicationModal, type ApplicationFormData } from "@/components/dashboard/application-modal"
...
import type { Application, ApplicationStatus, HomeData, UpcomingEvent } from "@/lib/types"
...
export default function DashboardPage() {
  ...
  const stats = homeData?.stats ?? { totalApplications: 0, replyRate: 0, rejections: 0 }
